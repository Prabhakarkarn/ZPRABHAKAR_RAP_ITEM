CLASS zpk_cl_rap100_gen_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zpk_cl_rap100_gen_data IMPLEMENTATION.
...
*  *   clear data
      ...
      DELETE FROM ZPK_RAP100_ATRAV.
    DELETE FROM ZPKRP100_AT000_D.

    "insert travel demo data
    INSERT ZPK_RAP100_ATRAV  FROM (
        SELECT
